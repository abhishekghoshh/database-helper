...
- [Apache Kafka: What it is and where it's going.](https://www.youtube.com/watch?v=9CrlA0Wasvk)
...
- [Confluent](https://www.youtube.com/@Confluent/playlists)
  ...
  - [Apache Kafka 101: Confluent's Flagship Course on Apache Kafka® Fundamentals ft. Tim Berglund](https://www.youtube.com/playlist?list=PLf38f5LhQtheK16nwnCYFqH23WUUvZfSb)
  - [Designing Event-Driven Microservices](https://www.youtube.com/playlist?list=PLa7VYi0yPIH0IpUKXb3q7NSjpJGO9GGGZ)
  - [Apache Kafka® Architecture | Kafka's Internal Components and How They Work](https://www.youtube.com/playlist?list=PLa7VYi0yPIH14oEOfwbcE9_gM5lOZ4ICN)
  - [Schema Registry 101 | Introduction to Schema Registry in Apache Kafka and How it Works](https://www.youtube.com/playlist?list=PLa7VYi0yPIH1KE10jwqmFEM61krd9WXQV)

  - [Event-Driven Microservices in Banking: Best practices for building reliable distributed systems and optimizing customer satisfaction](https://www.youtube.com/playlist?list=PLa7VYi0yPIH0n0qDF9mMiSbO1uORhAnSY)
  - [Spring Framework and Apache Kafka® Tutorials | Spring for Apache Kafka 101](https://www.youtube.com/playlist?list=PLa7VYi0yPIH1Su3nVNuRePh2Gdw6_UujU)

  - [Designing Events and Event Streams | Apache Kafka® Event Streaming](https://www.youtube.com/playlist?list=PLa7VYi0yPIH145SVtPoh3Efv8xZ1ehUYy)
  ...
  - [Building Data Pipelines with Apache Kafka® and Confluent | Data Pipelines Tutorials](https://www.youtube.com/playlist?list=PLa7VYi0yPIH1MculjFWJxs-aENPxRHHOS)
...
- [Apache Kafka Vs. Apache Flink](https://www.youtube.com/watch?v=gAIOZiJVECg)
...
- [Kafka Is Hard Because You Keep Ignoring These Patterns](https://codingplainenglish.medium.com/kafka-is-hard-because-you-keep-ignoring-these-patterns-588b2ebac3c0)
- [The Kafka Rebalancing Issue That Taught Me Everything About Distributed Systems](https://medium.com/@neerupujari5/the-kafka-rebalancing-issue-that-taught-me-everything-about-distributed-systems-a7d5cf80a2c4)
- [Apache Kafka: The Beating Heart of Real-Time Systems (with Uber & Netflix Examples)](https://medium.com/codetodeploy/apache-kafka-the-beating-heart-of-real-time-systems-with-uber-netflix-examples-214438936466)
...
- [Kafka with confluent-kafka-go: A Go Developer's Playbook](https://medium.com/@harshithgowdakt/kafka-with-confluent-kafka-go-a-go-developers-playbook-30f4993f5248)
...
- [Go & Kafka: From Theory to Practice](https://medium.com/@bhaumikmaan/go-kafka-from-theory-to-practice-96e0757e02ca)
- [Kafka Integration in Go Using Sarama: Producer and Consumer Setup](https://medium.com/@jamil.ahmad7720/kafka-integration-in-go-using-sarama-producer-and-consumer-setup-3237a7fbc0fd)
- [Delaying and Aggregating Kafka Messages with Goroutines and Caching](https://medium.com/safe-engineering/delaying-and-aggregating-kafka-messages-with-goroutines-and-caching-1b6f73019172)



### Kafka with Spring boot

- [Kafka Consumer Strategies: Spring Boot Kafka Listener vs. Kafka Streams Topology](https://medium.com/@vamcrulz09/kafka-consumer-strategies-spring-boot-kafka-listener-vs-kafka-streams-topology-67880d281868)
...
- [Understanding Kafka KRaft: How Controllers and Brokers Talk in the Zookeeper-less World](https://medium.com/@katyagorshkova/understanding-kafka-kraft-how-controllers-and-brokers-talk-in-the-zookeeper-less-world-a5e05a063f34)
  - [Docker Compose for Running Kafka in Kraft Mode](https://medium.com/@katyagorshkova/docker-compose-for-running-kafka-in-kraft-mode-20c535c48b1a)
    - [katyagorshkova/kafka-kraft](https://github.com/katyagorshkova/kafka-kraft)
...
- [Handling Schema Evolution in Kafka Connect: Patterns, Pitfalls, and Practices](https://medium.com/cloudnativepub/handling-schema-evolution-in-kafka-connect-patterns-pitfalls-and-practices-391795d7d8b0)
...
- [Tool ⚙️: UI for Apache Kafka — Clean, Modern, and Easy to Use](https://medium.com/@vortj/ui-for-apache-kafka-clean-modern-and-easy-to-use-20041ecb5578)
  - you should switch to Kafbat UI, basically a fork of Kafka UI after it was deprecated:
...
- [Introduction to Apache Kafka: A Hands-On Guide with Docker](https://medium.com/@akmuthumala/introduction-to-apache-kafka-a-hands-on-guide-with-docker-bc65ae1009e5)
- [Running Kafka in a Docker Container,with KafkaUI and Minio](https://medium.com/@sanjeets1900/running-kafka-in-a-docker-container-with-kafkaui-and-minio-f26ce7264158)
