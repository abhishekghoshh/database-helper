...
#### neo4j migrations 
- [official documentation](https://neo4j.com/labs/neo4j-migrations/2.0/introduction/)
- [Migrating Neo4J graph schemas in managed Kubernetes](https://www.youtube.com/watch?v=P-XkvEHPXKQ)
